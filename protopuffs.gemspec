...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.txt", "README.rdoc", "VERSION.yml", "lib/protopuffs", "lib/protopuffs/message", "lib/protopuffs/message/base.rb", "lib/protopuffs/message/field.rb", "lib/protopuffs/message/wire_type.rb", "lib/protopuffs/parser", "lib/protopuffs/parser/parser.rb", "lib/protopuffs/parser/protocol_buffer.treetop", "lib/protopuffs.rb", "test/abstract_syntax_tree_test.rb", "test/fixtures", "test/fixtures/proto", "test/fixtures/proto/person.proto", "test/message_base_test.rb", "test/message_field_test.rb", "test/parse_tree_test.rb", "test/protopuffs_test.rb", "test/test_helper.rb", "test/wire_format_test.rb"]
  s.has_rdoc = true
